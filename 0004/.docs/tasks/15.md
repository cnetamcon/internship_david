...
- add settings subtitle_gen_line_mode :
  When all lines for subtitle is full - for the next subtitle
  0 - Remove first line. This will move all lines up one position
  1 - Remove all lines. We wait until all the lines are filled in
- initialize SubtitleWordsBufferService with subtitle generation mode
- implement a choose depending on the settings
...
Write: 'interested in like, you know, um, | a, uh, an awkward interaction or a'
Write: 'smile or a contemptuous glance or | maybe a very awkward wink, or maybe'
Write: 'even something like a handshake. | Here they are arriving at number'
Write: 'ten. And look at this lucky | policeman gets to shake hands with'
Write: 'the president of the United | States. Oh, and here comes the'
Write: 'Prime Minister. They know. | So, um, a handshake or the lack of'
Write: 'a handshake can have us talking for | weeks and weeks and weeks, even the'
Write: 'BBC and the New York Times. So, so | obviously, when we think about'
Write: 'nonverbal behavior or body | language, but we call it nonverbals'
Write: 'as social scientists, it's | language. So we think about'
Write: 'communication when we think about | communication, we think about'
Write: 'interactions. So what is your body | language communicating to me.'
```
